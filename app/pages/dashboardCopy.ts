...
export const getDashboardCopy = (language: AppLanguage) => ({
  ...
  employee: {
    ...
    debtCard: {
      ...
      helper: pickByLanguage(language, 'Считается по всем рабочим сменам до сегодня и подтвержденным выплатам.', 'Calculated from all worked shifts up to today and approved payments.'),
